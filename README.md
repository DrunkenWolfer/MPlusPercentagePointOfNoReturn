...
Addon para World of Warcraft que permite guardar y mostrar notas de porcentaje por mazmorra M+, con marco movible y selección rápida de instancia. Original author: IggyDarr
Modified by Pacopao.
## Compatibilidad

- WoW Midnight `12.0.5 (67314)` o superior
- Interface en `.toc`: `120001, 120005`
...
2. Reinicia el juego o usa `/reload`.
